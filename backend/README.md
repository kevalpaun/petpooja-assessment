...
This project is a **Node.js + Express + MySQL backend application** built using **raw SQL (no ORM)** and a clean **MVC architecture**.  
It supports **CRUD operations**, **pagination with total count**, **soft delete**, **centralized routing**, **API logging using Morgan**, and **statistical reports**.
...
Insert Dummy employee data (Optional)
